...
from webrob.utility.utility import *
...
def menu():
    ...
    episode_choices_map = _generate_episode_choices_map_from_experiment_list()
    ...
    for category in sorted(episode_choices_map.keys()):
        ...
        for (exp, category) in cat_episodes:
            ...
            for t in meta['platforms']:
                if t not in technology_episodes.keys():
                    technology_episodes[t] = []
